...
class Services_Qiniu_Etag
{
    ...
    {
        return (($fsize + (Services_Qiniu_Config::BLOCK_SIZE - 1)) / Services_Qiniu_Config::BLOCK_SIZE);
    }
    ...
    public static function sum($filename)
    {
        ...
        if ($blockCnt <= 1) {
            ...
            $fdata = fread($fhandler, Services_Qiniu_Config::BLOCK_SIZE);
            if ($err !== null) {
                fclose($fhandler);
                return array(null, $err);
            }
