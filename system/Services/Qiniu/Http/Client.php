...
class Services_Qiniu_Http_Client
{
    public static function get($url, array $headers = array())
    {
        $request = new Services_Qiniu_Http_Request('GET', $url, $headers);
        return self::sendRequest($request);
    }

    public static function post($url, $body, array $headers = array())
    {
        $request = new Services_Qiniu_Http_Request('POST', $url, $headers, $body);
        return self::sendRequest($request);
    }
    ...
    {
        $sdkInfo = "QiniuPHP/" . Services_Qiniu_Config::SDK_VER;
    ...
    private static function sendRequest($request)
    {
        ...
        $ret = curl_errno($ch);
        if ($ret !== 0) {
            $r = new Services_Qiniu_Http_Response(-1, $duration, array(), null, curl_error($ch));
            curl_close($ch);
            return $r;
        }
        ...
        curl_close($ch);
        return new Services_Qiniu_Http_Response($code, $duration, $headers, $body, null);
    }
